...
import com.flightbooking.dto.RouteInput;
import com.flightbooking.exception.CategoryNotFoundException;
...
&& (airlineRoute.isClassBusiness() == categoryList.get(0)
 ...
 MultiCityRouteResponse multicityRespone = new MultiCityRouteResponse(date, arrival, destination,searchedMulticityAirlineRouteList);
